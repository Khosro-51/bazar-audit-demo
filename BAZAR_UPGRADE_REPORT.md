...
### به‌روزرسانی پنجم v1.1: دیزاین‌سیستم حرفه‌ای (سطح تیمی)

برای اینکه بازدیدکننده حس کند تیم حرفه‌ای پشت ابزار است:

- **لوگوی SVG اختصاصی:** شش‌ضلعی سبز با سه کندل سفید داخلش + وردمارک مونواسپیس `BAZAR·AUDIT` — در سایدبار با چیپ نسخه.
- **حذف کامل ایموجی از هدرها:** سیستم آیکون وکتوری یکدست (استروک 1.6، سبک Feather) با ۷ آیکون: mail/key/radar/cube/shield/pulse/upload.
- **هدرهای شماره‌دار دیزاین‌سیستمی:** هر بخش با فرمت `01 / [آیکون] عنوان` و خط زیرین — صفحه قفل (01 ایمیل / 02 کد)، صفحه اصلی (01 پروفایل‌ها / 02 آپلود)، گزارش (01 سلامت / 02 بینش‌ها / 03 نقشه سه‌بعدی).
- **دکمه‌های CTA:** دکمه‌های اصلی (دریافت کد / Unlock) سبز توپر با متن تیره و glow در hover.
- **چیدمان صفحه قفل:** ستون مرکزی محدود (نه تمام‌عرض) + نوار وضعیت ترمینالی پایین (● SYSTEM ONLINE · ENGINE v1.1 · ...) با نقطه چشمک‌زن.
